...
# IGW
resource "aws_internet_gateway" "quickops_igw" {
  vpc_id = aws_vpc.quickops_vpc.id
  tags = {
    Name       = format("%s igw", var.cluster_name)
    created_by = var.created_by
  }
  depends_on = [aws_vpc.quickops_vpc]
}

#public subnet 1
resource "aws_subnet" "quickops_subnet_public_1" {
  vpc_id                  = aws_vpc.quickops_vpc.id
...
#public subnet 2
resource "aws_subnet" "quickops_subnet_public_2" {
  vpc_id                  = aws_vpc.quickops_vpc.id
...
#private subnet 1
resource "aws_subnet" "quickops_subnet_private_1" {
  vpc_id            = aws_vpc.quickops_vpc.id
...
#private subnet 2
resource "aws_subnet" "quickops_subnet_private_2" {
  vpc_id            = aws_vpc.quickops_vpc.id
...
#Public RT
resource "aws_route_table" "quickops_subnet_public_rt" {
  vpc_id = aws_vpc.quickops_vpc.id
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.quickops_igw.id
  }
...
resource "aws_route_table_association" "quickops_subnet_public_rt_association1" {
  subnet_id      = aws_subnet.quickops_subnet_public_1.id
  route_table_id = aws_route_table.quickops_subnet_public_rt.id
  depends_on     = [aws_route_table.quickops_subnet_public_rt, aws_subnet.quickops_subnet_public_1]
}

resource "aws_route_table_association" "quickops_subnet_public_rt_association2" {
  subnet_id      = aws_subnet.quickops_subnet_public_2.id
  route_table_id = aws_route_table.quickops_subnet_public_rt.id
  depends_on     = [aws_route_table.quickops_subnet_public_rt, aws_subnet.quickops_subnet_public_2]
}
